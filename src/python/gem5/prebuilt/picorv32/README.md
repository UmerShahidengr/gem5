# picorv32 GEM5 Board Specs and Usage

## Specs for the picorv32 Unmatched
...
## Running the picorv32 Unmatched Board in GEM5
...
2. Run the board's hello world SE mode simulation script.
    ```sh
    ./build/RISCV/gem5.opt configs/example/gem5_library/picorv32-run.py riscv-hello
    ```
    ...
    ```sh
    ./build/RISCV/gem5.opt configs/example/gem5_library/picorv32-run.py microbench/CCa.RISCV
    ```
    You can add one optional argument to the binary. Here is an example:
    ```sh
    ./build/RISCV/gem5.opt configs/example/gem5_library/picorv32-run.py microbenchmarks/control_complex.RISCV --argv=10
    ```
